...
/*
 * @author : zszhang
 * @doc: 实现对java.time.Local* 类的JSON反序列化
 */
public class Jdk8DateDeserializer implements ObjectDeserializer {
	public final static ObjectDeserializer instance = new Jdk8DateDeserializer();
